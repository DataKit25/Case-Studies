...
### Introduction 
I assume the role of a Jr. Data Analyst in a fictional company, Cyclistic, to undertake this case study. In order to answer the key business questions, carefully following the data analysis process: Ask, Prepare, Process, Analyse, Share, and Act. 
...
### Ask 
#### Business Task
Create marketing tactics to transform casual riders into annual members 
...
* The rows with the NULL values are removed.
...
Again in the graph that shows the average ride span per day we can see that the ride span of the member riders stays flat
with a slight increase on Saturday and Sunday, indicating that the members use this serivice for daily commute. <br>
While the trend for casual rides sees a dip in between Monday and Friday, it gradually increases till Thrusday which then falls on Saturday and Sunday. 

**Ride per month**

![Ride per month](https://github.com/DataKit25/Case-Studies/assets/138516708/5e983eb4-c42e-4104-bcc1-e7537ed7f5cf)

Here we can see the trend in total trips over the months, we ca see a big spike in the total trips in the month of September. This could be due to several public festivals and or holidays. 
...
We see that casual riders are mosre likely to start their trips near leisure spots, like museum, harbours etc, while members tend to use it for commuting and other essential tasks. 
...
In the above three graphs thats shows us the riding trends of the three rideable types, we see that the most used bike type is the classic bike, which is common between member and casual users. While casual users use all three offerings of bike types, the member users don't tend to use docked bikes.
